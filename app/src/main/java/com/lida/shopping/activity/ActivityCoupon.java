...
import com.lida.shopping.fragment.FragmentCouponNotUsed;
...
public class ActivityCoupon extends BaseFragmentActivity {
    ...
    private static final String[] CHANNELS = new String[]{"未使用", "已过期", "已使用"};
    ...
    private void initView() {
        ...
        fragments.add(new FragmentCouponNotUsed());
        fragments.add(new FragmentCouponNotUsed());
        fragments.add(new FragmentCouponNotUsed());
    ...
    private void initMagicIndicator() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                clipPagerTitleView.setTextColor(Color.parseColor("#8A8888"));
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                indicator.setColors(Color.parseColor("#444444"));
                return indicator;
            }
