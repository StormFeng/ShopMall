...
import com.lida.shopping.adapter.AdapterFragmentCarefulSelect;
...
public class FragmentGoodCarefulSelect extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        gvGood.setAdapter(new AdapterFragmentCarefulSelect(_activity));
        return v;
    }
